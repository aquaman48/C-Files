...
//function definition for void displayBoard()
void displayBoard()
{
	system("CLS");
	printf("\n\t|\t|\n");
	...
	printf("\t|\t|\n");
}// end of function, notice it is void and we are not returning a value.

//begin verifySelection function. Here we are initializing the 'X' for iPlayer 1 or 0
//if iPlayer is 1 then they will be 'O'. 
int verifySelection(int iSquare, int iPlayer)
{
	...
	else if (board[iSquare - 1] == ' ' && iPlayer == 2)
	{
		...
		return 1;
}//end of verify selection function

//begin function defnition for win
void checkForWin()
{
	int catTotal = 0;
	int x;
